...
export default function PlatformAuditTrailScreen() {
    ...
    const logs = [
        { id: "a1", ts: "2024-01-15 14:32", org: "Acme Corp", user: "sarah@acme.com", action: "CREATE", resource: "Agent", details: "Created: mike@acme.com", ip: "192.168.1.5" },
        { id: "a2", ts: "2024-01-15 14:15", org: "Acme Corp", user: "john@acme.com", action: "UPDATE", resource: "Call", details: "Added tag: hot-lead", ip: "192.168.1.12" },
        { id: "a3", ts: "2024-01-15 13:48", org: "Beta Inc", user: "admin@beta.com", action: "LOGIN", resource: "System", details: "Successful", ip: "192.168.1.1" },
        { id: "a4", ts: "2024-01-15 13:20", org: "Acme Corp", user: "priya@acme.com", action: "EXPORT", resource: "Calls", details: "Exported 450 records", ip: "192.168.1.8" },
        { id: "a5", ts: "2024-01-15 12:44", org: "Gamma LLC", user: "admin@gamma.com", action: "UPDATE", resource: "Setting", details: "Changed recording retention: 60d → 90d", ip: "192.168.1.1" },
    ];
    ...
    const cols: TableColumn<typeof logs[0]>[] = [
        ...
        { key: "org", label: "Org", width: "w-[120px]", render: (l) => <span className="text-sm font-medium text-gray-700">{l.org}</span> },
    ...
    return (
        <TableCard
            title="Audit Trail"
            breadcrumbs={[{ label: "Platform Admin", href: "/admin/platform" }, { label: "Audit Trail" }]}
            searchPlaceholder="Search by user, action, resource, or org..."
